...
| [Community Market](../dsh-community-market/README.md) | The built-in Market Host/Client, extensible catalog sources, user selection, install confirmation, and safety boundary |
| [Market catalog provider contract](../dsh-community-market/docs/catalog-provider-contract.md) | Implemented schemas, query parameters, single-selected-source behavior, and adapter compatibility rules |
| [Catalog source governance](../dsh-community-market/docs/catalog-source-governance.md) | Open access, neutrality and non-discrimination, material-relationship disclosure, restrictions, and reconsideration |
