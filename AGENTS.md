...
- `dsh-community-market/` owns the implemented community-market Host/Client runtime, public catalog contract, reviewed provider adapters, source UI, and managed package operations. Keep its shipped behavior, source governance, bilingual documentation, and verification records aligned.
